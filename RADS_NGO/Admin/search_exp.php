            ...
            <div id="page-content">
                ...
                <div class="block block-themed block-last">
                    ...
                    <div class="block-content">
						...
						<form action="search_exp1.php" method="post" class="form-horizontal" name="formID" id="formID">
                            <!-- Default Inputs -->
...
?>  
                            ...
                            <!-- END Form Buttons -->
												...
												<form action="search_exp2.php" method="post" class="form-horizontal" name="formID" id="formID">
                            <!-- Default Inputs -->
