                            ...
                            <ul class="nav pull-right">
                                ...
                                <li class="dropdown dropdown-notifications">
                                     <ul class="dropdown-menu">
                                        <li>
                                            <div class="alert">
                                                <i class="icon-bell"></i> <strong><a href="user_view.php">User Profile</a></strong> 
                                            </div>
                                ...
                                <li class="dropdown dropdown-notifications">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="alert">
                                                <i class="icon-bell"></i> <strong><a href="">News</a></strong> 
                                            </div>
                                        </li>
                             ...
                             <li class="dropdown dropdown-notifications">
                                   <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Sign Out</a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="alert alert-error">
