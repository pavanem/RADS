...
<tr>
<td class="span1 text-center"><?php echo $row['exp_id'];?></td>
...
<td class="span1 text-center"><a href="expenses_delete.php?a=<?php echo $row['exp_id'];?>">DELETE</a></td>
<td class="span1 text-center"><a href="expenses_edit.php?a=<?php echo $row['exp_id'];?>">EDIT</a></td>
</tr>
