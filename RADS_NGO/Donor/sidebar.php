   <!-- Sidebar Tabs -->
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="side-tab-menu">
                                ...
                                <nav id="primary-nav">
                                    <ul>
                                        <li>
                                            <a href="home.php" class=" active"><i class="glyphicon-display"></i>Home</a>
                                        </li>
										 <li>
                                            <a href="user_view.php" class=" active"><i class="glyphicon-display"></i>Profile</a>
                                        </li>
										<li>
                                            <a href="donation_view.php" class=" active"><i class="glyphicon-display"></i>Donations</a>
                                        </li>
										<li>
                                            <a href="feedback_view.php" class=" active"><i class="glyphicon-display"></i>Feedback</a>
                                        </li>
            ...
            <div id="pre-page-content">
                <h1><i class="glyphicon-dashboard themed-color"></i>Dashboard<br><small>Welcome <strong>Donor</strong>, everything looks good!</small></h1>
            </div>
